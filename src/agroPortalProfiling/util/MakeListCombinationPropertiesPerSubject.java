...
public class MakeListCombinationPropertiesPerSubject {
	...
	public static ArrayList<UriListAndUriListAndNumberListAndNumber> makeList(Model model) {
		...
		System.out.println("Running time for ListCombinationPropertiesPerSubject: " + AgroPortalProfilingUtil.getDurationAsString(Duration.between(start0, end0).toMillis()));
