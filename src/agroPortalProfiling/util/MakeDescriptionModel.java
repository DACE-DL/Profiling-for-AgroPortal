...
public class MakeDescriptionModel {
	...
	public static OntModel  makeModel(ArrayList<UriListAndUriAndUriListAndNumber> listCombinationPropertiesClassRelationships,
	 ...
	 ArrayList<UriAndNumber> listMostUsedAnnotationProperty, ArrayList<UriAndNumber> listMostUsedRDFproperty) {
		...
		String rdf = AgroPortalProfilingConf.rdf;
		String skos = AgroPortalProfilingConf.skos;
		String owl = AgroPortalProfilingConf.owl;
		...
		for (UriAndListUriListAndListUriList resource : listOfRelationships) {
			relationshipsBuilder.append(agroPortalProfiling.util.AgroPortalProfilingUtil.buildTurtleClassString(resource.getListUriList1(), resource.getListUriList2(), listCombinationPropertiesWithNewClass, listMostUsedAnnotationProperty ));
		...
		relationshipsBuilder.append(agroPortalProfiling.util.AgroPortalProfilingUtil.buildTurtleObjectPropertyString(listMostUsedObjectProperty, listOfPropertyDomainAndRange, maxOfUnion));

		// On s'occupe maintenant des datatype properties
		relationshipsBuilder.append(agroPortalProfiling.util.AgroPortalProfilingUtil.buildTurtleDatatypePropertyString(listMostUsedDatatypeProperty, listOfPropertyDomainAndRange, maxOfUnion));  

		// On s'occupe maintenant des rdfs properties
		relationshipsBuilder.append(agroPortalProfiling.util.AgroPortalProfilingUtil.buildTurtleRDFpropertyString(listMostUsedRDFproperty, listOfPropertyDomainAndRange, maxOfUnion));  
		...
		// }
		relationshipsBuilder.append(agroPortalProfiling.util.AgroPortalProfilingUtil.buildTurtleAnnotationPropertyString(listMostUsedAnnotationProperty,
		...
		// System.out.println("Running time for making description model: " + AgroPortalProfilingUtil.getDurationAsString(Duration.between(start0, end0).toMillis()));
