...
public class MakelistCombinationPropertiesClassRelationships {
	...
	public static ArrayList<UriListAndUriAndUriListAndNumber> makeList(Model model, ArrayList<UriListAndUriList> listCombinationPropertiesWithNewClass) {
		...
		for (UriListAndUriList resource : listCombinationPropertiesWithNewClass) {
			...
			//System.out.println("Running time for one: " + AgroPortalProfilingUtil.getDurationAsString(Duration.between(start1, end1).toMillis()));
		}
		// tri de la liste
		...
		System.out.println("Running time for ListCombinationPropertiesClassRelationships: " + AgroPortalProfilingUtil.getDurationAsString(Duration.between(start0, end0).toMillis()));
